...
##Pmod Header JA
#set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports usb_uart_rxd];#Sch name = JA1
#set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports usb_uart_txd];#Sch name = JA2
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports pwm_0];#Sch name = JA3
