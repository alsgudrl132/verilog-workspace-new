...
(* CORE_GENERATION_INFO = "soc_pwm,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_pwm,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=13,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "soc_pwm.hwdef" *) 
module soc_pwm
   (led_16bits_tri_o,
    pwm_0,
    reset,
  ...
  soc_pwm_axi_gpio_0_0 axi_gpio_0
  ...
  soc_pwm_axi_uartlite_0_1 axi_uartlite_0
       (.rx(usb_uart_rxd),
        .s_axi_aclk(microblaze_riscv_0_Clk),
