...
//Date        : Mon Sep 15 10:40:14 2025
//Host        : min-MacBookPro15-1 running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target soc_iic_txtlcd.bd
//Design      : soc_iic_txtlcd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module microblaze_riscv_0_local_memory_imp_1NF3Y05
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > soc_iic_txtlcd microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_iic_txtlcd_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  soc_iic_txtlcd_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  soc_iic_txtlcd_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  soc_iic_txtlcd_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  soc_iic_txtlcd_lmb_bram_0 lmb_bram
...
(* CORE_GENERATION_INFO = "soc_iic_txtlcd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_iic_txtlcd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=12,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "soc_iic_txtlcd.hwdef" *) 
module soc_iic_txtlcd
   (led_0,
    reset,
    scl_0,
    sda_0,
  ...
  output scl_0;
  output sda_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN soc_iic_txtlcd_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  soc_iic_txtlcd_axi_smc_0 axi_smc
  ...
  soc_iic_txtlcd_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
        ...
        .tx(usb_uart_txd));
  soc_iic_txtlcd_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  soc_iic_txtlcd_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > soc_iic_txtlcd microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_iic_txtlcd_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_1NF3Y05 microblaze_riscv_0_local_memory
  ...
  soc_iic_txtlcd_myip_iic_txtlcd_0_0 myip_iic_txtlcd_0
       (.led(led_0),
        ...
        .scl(scl_0),
        .sda(sda_0));
  soc_iic_txtlcd_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
